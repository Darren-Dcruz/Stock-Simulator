...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> &
    Pick<RechartsPrimitive.TooltipProps<number | string | (number | string)[], string>, "active" | "payload" | "label"> & {
      hideLabel?: boolean
      hideIndicator?: boolean
      indicator?: "line" | "dot" | "dashed"
      nameKey?: string
      labelKey?: string
      labelFormatter?: (label: React.ReactNode, payload: RechartsPrimitive.Payload<number | string | (number | string)[], string>[]) => React.ReactNode
      labelClassName?: string
      formatter?: RechartsPrimitive.TooltipProps<number | string | (number | string)[], string>["formatter"]
      color?: string
    }
>((
  {
